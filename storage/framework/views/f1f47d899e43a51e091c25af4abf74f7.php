    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <?php elseif(Auth::check() && Auth::user()->role === 'kaprog'): ?>
                ...
                <a href="" class="nav-item nav-link <?php echo e(request()->routeIs('laporan.kaprog') ? 'active' : ''); ?>">
                    <i class="fa fa-file-alt me-2"></i>Laporan
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-item nav-link <?php echo e(request()->routeIs('login') ? 'active' : ''); ?>">
...
<?php /**PATH D:\Formatif_sumatif\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>