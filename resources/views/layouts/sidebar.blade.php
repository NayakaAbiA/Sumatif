    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            @if (Auth::check() && Auth::user()->role === 'kurikulum')
                <a href="{{ route('dashboard.kurikulum') }}" class="nav-item nav-link active">
                    <i class="fa fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="{{ route('upload.kurikulum') }}" class="nav-item nav-link">
                    <i class="fa fa-book me-2"></i>Blangko Kisi - Kisi
                </a>
                <a href="{{ route('daftarhadir.kurikulum') }}" class="nav-item nav-link">
            ...
            @elseif (Auth::check() && Auth::user()->role === 'guru')
                <a href="{{ route('dashboard.guru') }}" class="nav-item nav-link active">
